            ...
            <form @submit.prevent="form_1()">
                <section class="input-block">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row info">
                                ...
                                <!-- <input :readonly="Status!=2 || user.Type=='SYSTEM' || user.Type==0" :class="{'no_border':Status!=2  || user.Type=='SYSTEM' || user.Type==0}" type="text" v-model="student_obj.Sort" class="form-control col-md-6"  required/> -->
                                <input readonly  type="text" v-model="student_obj.Sort" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label> <span class="text-danger">* </span>姓名</label>
                                <input :readonly="!edit" v-model="student_obj.Name" type="text" class="form-control col-md-6" required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>性别</label>
                                <input :readonly="!edit"  v-model="student_obj.Sex" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="row info">
                                ...
                                <input :readonly="!edit" v-model="student_obj.Nation" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>文化程度</label>
                                <input :readonly="!edit" v-model="student_obj.EducationLevel" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>身份证号码</label>
                                <input :readonly="!edit" v-model="student_obj.IdCardNo" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="row info">
                                ...
                                <input readonly  v-model="student_obj.TrainingType" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>工作单位</label>
                                <input :readonly="!edit" v-model="student_obj.Company" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>联系电话</label>
                                <input :readonly="!edit" v-model="student_obj.ContactNumber" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="row info">
                                ...
                                <input :readonly="!edit" v-model="student_obj.OriginalTechnologyLevel" type="text" class="form-control col-md-6"  required/>
                            </div>
                            <!-- <div class="row info">
                        ...
                        <div class="col-12">                        
                            <div class="row info">
                                ...
                                <input :readonly="!edit" v-model="student_obj.Address" type="text" class="form-control col-md-9"  required/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-footer mt-5 d-flex justify-content-center">
                        ...
                        <button type="submit" v-if="Status==2 && user.Type!='SYSTEM' && user.Type!=0" class="app-btn">提交审核</button>
                        <button type="button" v-if="edit" @click="saveEdit" class="app-btn">保存修改</button>
                    </div>
                </section>
            </form>
...
<script>
	...
	export default {
        ...
        saveEdit() {
          console.log(this.student_obj)
          ajax('patch','/student', JSON.stringify(this.student_obj), (re) => {
            re = JSON.parse(re);
            if(re.Result){
              this.$alert('修改成功！');
            }
