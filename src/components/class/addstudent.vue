            ...
            <form @submit.prevent="form_1()">
                <section class="input-block">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row info">
                                ...
                                <input type="text" v-model="student_obj.Sort" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label> <span class="text-danger">* </span>姓名</label>
                                <input v-model="student_obj.Name" type="text" class="form-control col-md-6" required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>性别</label>
                                <input  v-model="student_obj.Sex" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="row info">
                                ...
                                <input  v-model="student_obj.Nation" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>文化程度</label>
                                <input v-model="student_obj.EducationLevel" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>身份证号码</label>
                                <input v-model="student_obj.IdCardNo" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="row info">
                                ...
                                <input v-model="student_obj.Company" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>联系电话</label>
                                <input v-model="student_obj.ContactNumber" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="row info">
                                ...
                                <input  v-model="student_obj.OriginalTechnologyLevel" type="text" class="form-control col-md-6"  required/>
                            </div>
                            <!-- <div class="row info">
                        ...
                        <div class="col-6">
                            <div class="row info">
                                <label><span class="text-danger">* </span>培训等级</label>
                                <input readonly v-model="student_obj.TrainingLevel" type="text" class="form-control col-md-6"  required/>
                            </div>
                        </div>
                        <!-- <div class="col-6">
                            <div class="row info">
                        ...
                        <div class="col-12">                        
                            <div class="row info">
                                ...
                                <input  v-model="student_obj.Address" type="text" class="form-control col-md-9"  required/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-footer mt-5 d-flex justify-content-center">
                        ...
                        <button  type="submit" class="app-btn">添加</button>
                    </div>
                </section>
            </form>
...
<script>
	...
	export default {
	  	...
	  	methods:{
            retu(){
              ...
              form_1(){
                ...
                ajax('post','/student',JSON.stringify(this.student_obj),this.modify)
              },
            modify(x){
                var x=JSON.parse(x);
                if(x.Result){
            ...
            class_return(x){
                var x=JSON.parse(x);
                this.student_obj.TrainingLevel=x.Memory.TrainingLevel
                this.student_obj.TrainingType=x.Memory.TrainingType
                console.log('班级信息',x)
            }
	  	},
	    created: function () {
	    ...
	    mounted: function () {
            ...
            //     this.get_student()
            // }
            this.student_obj.Class=query.class;
            //查询班级信息
            ajax("get", "/class/id", {id:this.student_obj.Class},this.class_return);
